...
export const pluginsList = [
         ...
         },
         {
           ...
           type: LbpFormCheckboxGroup.name
         },
         {
           i18nTitle: {
             'en-US': 'Form Radio',
