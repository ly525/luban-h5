...
目录
- [鲁班 H5 是什么？](#%E9%B2%81%E7%8F%ADh5%E6%98%AF%E4%BB%80%E4%B9%88)
- [Demo](#Demo)
- [Features](#features)
...
### 快速开始
请参照[鲁班 H5-在线文档](https://ly525.github.io/luban-h5/zh/)的 `快速开始` 章节
...
## 如何贡献
所有合理的改动、优化、修正，新的组件，或者文档的修正、更新相关的提交都会被接受
